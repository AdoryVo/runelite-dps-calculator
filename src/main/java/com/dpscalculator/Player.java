...
public class Player {
    ...
    //spec1 used for salve/s.helm
    //stab, slash, crush, magic, range 0-4
    //accurate, controlled, n/a, range 0-2
    //type specifier for npc: 0 for undead, 1 for demon, 2 for dragon, 3 for vorkath (undead/dragon)
